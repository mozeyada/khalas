          ...
          <div className="text-center py-6 animate-in zoom-in-95 fade-in duration-500">
            ...
            <div className="space-y-3">
              <button
                ...
                className="group relative w-full overflow-hidden rounded-md bg-brand px-4 py-3.5 text-sm font-semibold text-white transition-all hover:bg-brand-hover active:scale-95"
              >
                <span className="relative z-10 flex items-center justify-center gap-2">
                  Enter Reset Code
